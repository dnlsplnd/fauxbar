...
- Spectrum analyzer: Blackman-Harris windowed STFT, log-frequency bar mapping (40 bands, 20Hz-20kHz), Prussian Blue coloring with attack/release ballistics and peak-hold
